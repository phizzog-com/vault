...
impl PluginRuntime {
    ...
    pub async fn load_plugin(&self, manifest_path: &str) -> Result<String, PluginError> {
        ...
        // Record metric
        self.resource_monitor.record_metric(&plugin_id, resources::PluginMetricEvent::PluginLoaded {
    ...
    pub async fn activate_plugin(&self, plugin_id: &str) -> Result<(), PluginError> {
        ...
        // Record metric
        self.resource_monitor.record_metric(plugin_id, resources::PluginMetricEvent::PluginActivated {
    ...
    pub async fn deactivate_plugin(&self, plugin_id: &str) -> Result<(), PluginError> {
        // Record metric
        self.resource_monitor.record_metric(plugin_id, resources::PluginMetricEvent::PluginDeactivated {
            plugin_id: plugin_id.to_string(),
