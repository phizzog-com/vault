...
mod cli_tests {
    ...
    mod create_command {
        ...
        async fn test_create_with_invalid_name() {
            ...
            for name in invalid_names {
                ...
                assert!(matches!(result.unwrap_err(), CliError::InvalidPluginName(_)));
            }
        }
    ...
    mod types_command {
        ...
        async fn test_types_command_uses_current_dir_if_no_path() {
            ...
            assert!(temp_dir.path().join(".vscode").join("settings.json").exists());
        }
        ...
        async fn test_generated_types_contain_apis() {
            ...
            let index_content = fs::read_to_string(project_path.join("types").join("index.d.ts")).unwrap();
        ...
        async fn test_generated_vscode_snippets() {
            ...
            let snippets_content = fs::read_to_string(project_path.join(".vscode").join("vault-plugin.code-snippets")).unwrap();
