...
impl MigrationReport {
    ...
    pub fn calculate_statistics(&mut self) {
        ...
        self.statistics = MigrationStatistics {
            ...
            success_rate: if self.total_files > 0 {
                ((self.migrated_count + self.already_had_id) as f64 / self.total_files as f64) * 100.0
            } else {
                0.0
            },
    ...
    pub fn summary(&self) -> String {
        ...
        summary.push_str(&format!("Migration Report for: {}\n", self.vault_root.display()));
        ...
        if !self.dry_run_changes.is_empty() {
            ...
            if self.dry_run_changes.len() > 10 {
                summary.push_str(&format!("... and {} more changes\n", self.dry_run_changes.len() - 10));
            }
        }
...
impl MigrationProgress {
    ...
    pub fn status(&self) -> String {
        ...
        format!("[{}/{}] {:.1}%{}", self.current, self.total, percentage, remaining)
    }
}
