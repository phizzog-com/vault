        ...
        <div class="sidebar">
          ...
          <div class="sidebar-header">
            <div class="sidebar-app-nav" id="sidebar-app-nav">
              <button class="sidebar-nav-button active" data-section="home" onclick="openHomeSection()" title="Home">
                <span class="sidebar-nav-icon">${icons.house({ size: 16 })}</span>
                <span class="sidebar-nav-label">Home</span>
              </button>
              <button class="sidebar-nav-button" data-section="tasks" data-requires-vault="true" onclick="openTasksSection()" title="Tasks">
                <span class="sidebar-nav-icon">${icons.listTodo({ size: 16 })}</span>
                <span class="sidebar-nav-label">Tasks</span>
              </button>
              <button class="sidebar-nav-button" data-section="sketches" data-requires-vault="true" onclick="openSketchesSection()" title="Sketches">
          ...
          <div class="file-tree-panel">
            <div class="file-tree-header" id="file-tree-header" style="display: none;">
              ...
              <div class="file-tree-controls">
                <button class="ribbon-button file-tree-action-button" onclick="showCreateFileModal('')" title="New File">
                  ${icons.fileText()}
                </button>
                <button class="ribbon-button file-tree-action-button" onclick="showCreateFolderModal()" title="New Folder">
                  ${icons.folderOpen()}
                </button>
                <button class="ribbon-button file-tree-action-button" onclick="refreshFileTree()" title="Refresh files">
                  ${icons.refresh()}
                </button>
                <div class="sort-menu-container">
                  <button id="sort-menu" class="ribbon-button file-tree-sort-button" title="Sort files" onclick="toggleSortMenu()">
                    ${icons.arrowDown()}
                  </button>
